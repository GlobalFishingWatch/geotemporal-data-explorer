...
if [ "$SO" == "Darwin" ]; then
    ...
    wget -O /bin/geotemporal-data-explorer https://storage.googleapis.com/raul-import/versions/latest/geotemporal-data-explorer-darwin-arm64-latest
else
    ...
    wget -O /bin/geotemporal-data-explorer https://storage.googleapis.com/raul-import/versions/latest/geotemporal-data-explorer-linux-amd64-latest
fi
unzip -u /var/lib/libduckdb/libduckdb.zip -d /var/lib/libduckdb
