...
var GEE_DATASETS = []types.Dataset{{
	...
	Configuration: types.Configuration{
		...
		Band:      "tasmin",
		Min:       &[]float64{165.31}[0],
		Max:       &[]float64{318.89}[0],
		Scale:     1,
		Offset:    0,
	...
	{
		ID:          "public-human-footprint-infrastructure",
		Name:        "Human footprint infrastructure",
		...
		Unit:        "",
		Configuration: types.Configuration{
			Images:    []string{"", "", "", "projects/HII/v1/driver/infrastructure"},
			Band:      "hii_infrastucture_driver",
			Min:       &[]float64{0}[0],
			Max:       &[]float64{1000}[0],
			Scale:     1,
			Offset:    0,
			Intervals: []string{"year"},
		},
	},
	{
		ID:          "public-human-footprint-population-density",
		Name:        "Human footprint population density",
		...
		Unit:        "",
		Configuration: types.Configuration{
			Images:    []string{"", "", "", "projects/HII/v1/driver/population_density"},
			Band:      "hii_popdens_driver",
			Min:       &[]float64{0}[0],
			Max:       &[]float64{1000}[0],
			Scale:     1,
			Offset:    0,
	...
	{
		ID:          "public-human-footprint-land-use",
		Name:        "Human footprint land use",
		...
		Unit:        "",
		Configuration: types.Configuration{
			Images:    []string{"", "", "", "projects/HII/v1/driver/land_use"},
			Band:      "hii_landuse_driver",
			Min:       &[]float64{0}[0],
			Max:       &[]float64{1000}[0],
			Scale:     1,
			Offset:    0,
...
var GFW_DATASETS = []types.Dataset{{
	...
	ID:          "public-global-presence:latest",
	Name:        "AIS Presence",
